...
export function PublicFooter({ footerConfig }: PublicFooterProps) {
  ...
  return (
    <footer style={{ backgroundColor: 'var(--theme-surface)', borderTop: '1px solid var(--theme-border)' }}>
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 py-14 lg:py-20">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-10">
          {showLogo && (
            <div className="lg:col-span-1">
              <div className="flex items-center gap-3 mb-4">
                {office.logo ? (
                  <img src={office.logo} alt={officeName} className="h-10 w-10 rounded-lg object-cover" />
                ) : (
                  <div
          ...
          {showNavLinks && (
            <div>
              <h3 className="text-sm font-semibold mb-4" style={{ color: 'var(--theme-primary)' }}>
                الصفحات
              </h3>
          ...
          {showSocialLinks && Object.values(socialLinks).some(Boolean) && (
            <div>
              <h3 className="text-sm font-semibold mb-4" style={{ color: 'var(--theme-primary)' }}>
                تابعنا
              </h3>
